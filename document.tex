...
\begin{enumerate}
    \item What is a version control system? Why are they useful?
        A version control system is a way of storing files and their history.
        It is useful to prevent data loss and see the history of a project.
    \item What is the difference between git and GitHub?
        git is a version control system, while GitHub hosts repositories stored
        with git.
    \item What is a repository?
        A repository is a collection of files stored in git.
    \item What is a commit?
        A commit describes how the repository
